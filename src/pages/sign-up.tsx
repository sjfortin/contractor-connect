                  ...
                  <div className="col-span-3 sm:col-span-2">
                    ...
                    <div className="mt-1 flex rounded-md shadow-sm">
                      ...
                      <input
                        ...
                        id="company-website"
                        className="block w-full flex-1 rounded-none rounded-r-md border-gray-300 focus:border-slate-500 focus:ring-slate-500 sm:text-sm"
                ...
                <div className="grid grid-cols-6 gap-6">
                  ...
                  <div className="col-span-6 sm:col-span-3">
                    ...
                    <select
                      ...
                      className="mt-1 block w-full rounded-md border border-gray-300 bg-white py-2 px-3 shadow-sm focus:border-slate-500 focus:outline-none focus:ring-slate-500 sm:text-sm"
                    >
